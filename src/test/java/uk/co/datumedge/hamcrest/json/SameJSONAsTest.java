...
public class SameJSONAsTest {
  ...
  @Test public void capturesStringValue() {
  ...
  @Test public void capturesNumberValue() {
    SameJSONAs matched = sameJSONAs("{\"foo\": +{foo_val}}").capturing();
    assertThat("{\"foo\": 5}", matched);
    Map<String, Object> captured =  matched.getCaptured();
    assertEquals(1, captured.size());
  ...
  @Test public void numberCanOnlyBeCapturedOnce() {
  ...
  @Test public void capturesBooleanValue() {
    SameJSONAs matched = sameJSONAs("{\"foo\": +{foo_val}}").capturing();
  ...
  @Test public void booleanCanOnlyBeCapturedOnce() {
    SameJSONAs matched = sameJSONAs("{\"foo\": \"+{foo1} +{foo2}\"}").capturing();
  ...
  @Test public void capturesNullValue() {
    SameJSONAs matched = sameJSONAs("{\"foo\": +{foo_val}}").capturing();
  ...
  @Test public void nullCanOnlyBeCapturedOnce() {
    SameJSONAs matched = sameJSONAs("{\"foo\": \"+{foo1} +{foo2}\"}").capturing();
  ...
  @Test public void captureTwiceFromSameString() throws Exception {
  ...
  @Test public void captureFromNestedList() throws Exception {
  ...
  @Test public void captureFromNestedObject() throws Exception {
  ...
  @Test public void capturingJSONObjectFails() throws Exception {
  ...
  @Test public void multipleNonCapturingElements() {
  ...
  @Test public void nonMatchingJSONArray() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void capturingJSONObjectString() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
    MatcherAssert.assertThat("{\"foo\":\"bar\"}",
  ...
  @Test public void fallThroughJSONObjectJSONArray() {
    HashMap<String, Object> map = new HashMap<String, Object>();
    assertThat("[\"foo\",\"bar\"]",
  ...
  @Test public void craftedToFallThroughIf() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
    assertThat("{\"foo\":\"miss\"}",
        not(sameJSONAs(
  ...
  @Test public void capturingJSONArrayString() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void capturingJSONArrayNumber() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void capturingJSONArrayBoolean() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void capturingJSONArrayNull() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void capturingJSONArrayFails() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
    assertThat("[\"foo\",[\"e1\",\"e2\"]]",
        not(sameJSONAs("[\"foo\",\"+{bar}\"]").capturingTo(map)));
    assertEquals(0, map.size());
  }
  @Test public void capturingJSONArrayJSONArray() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void fallThroughJSONArrayJSONObject() {
    HashMap<String, Object> map = new HashMap<String, Object>();
    assertThat("{\"foo\":[\"e1\",\"e2\"]}",
  ...
  @Test public void fallThroughStringString() {
    HashMap<String, Object> map = new HashMap<String, Object>();
    assertThat("bar",
  ...
  @Test public void matchingTwiceJSONObject() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void matchingMiddle() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void testMatchingTwiceJSONArray() throws Exception {
    HashMap<String, Object> map = new HashMap<String, Object>();
  ...
  @Test public void capturingUnorderedArray() {
